...
namespace Bolt.Client.Channels
{
    ...
    /// </summary>
    public class RecoverableStatefullChannel : RecoverableChannel, ISessionProvider, IContractProvider
    {
        ...
        public RecoverableStatefullChannel(Type contract, IServerProvider serverProvider, ClientConfiguration clientConfiguration)
        ...
        public RecoverableStatefullChannel(Type contract, Uri server, ClientConfiguration clientConfiguration)
        ...
        public RecoverableStatefullChannel(Type contract, IServerProvider serverProvider, ClientConfiguration clientConfiguration, IClientSessionHandler sessionHandler)
            : base(serverProvider, clientConfiguration)
        {
            if (contract == null) throw new ArgumentNullException(nameof(contract));
        ...
        public RecoverableStatefullChannel(RecoverableStatefullChannel proxy)
            : base(proxy)
        {
